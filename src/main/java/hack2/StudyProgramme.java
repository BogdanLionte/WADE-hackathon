...
public class StudyProgramme {
    ...
    private int learningFormId;
    private String studyCycle;
    private int studyCycleId;
    ...
    public int getAccreditationTypeId() {
        return accreditationTypeId;
    }

    public void setAccreditationTypeId(int accreditationTypeId) {
    ...
    public int getLearningFormId() {
        return learningFormId;
    }

    public void setLearningFormId(int learningFormId) {
        this.learningFormId = learningFormId;
    }
    ...
    public int getStudyCycleId() {
        return studyCycleId;
    }

    public void setStudyCycleId(int studyCycleId) {
        this.studyCycleId = studyCycleId;
    }
